...
# print(retractions_df.columns)
# print(raw_df.columns)
raw_df = alldata_df[['Record ID', 'Author','Title','Year','Journal','Cited by','Institution','Publisher','Document Type','Publication Stage','Open Access', 'Country', 'Rank']].copy()
...
raw_df['Inst_Count'] = raw_df['Intitution'].str.count(';') + 1
