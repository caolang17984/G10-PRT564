...
raw_df = pd.read_csv('download/data_2018.csv', encoding='ISO-8859-1')
raw_df.columns = ['Author','Title','Year','Journal','Cited by','Institution','Publisher','Document Type','Publication Stage','Open Access','Record ID']
raw_df = raw_df[['Record ID', 'Author','Title','Year','Journal','Cited by','Institution','Publisher','Document Type','Publication Stage','Open Access']]
